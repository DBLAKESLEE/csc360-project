...
\IEEEPARstart{H}{ere} is an example of how to cite\cite{ref1}.
    Searching and sorting data structures is fundamental to all data science, so fast algorithms are critical.
    
    The insertion sort...(finish the sentence here)
...
\indent
    ...
    The binary search implemented here will be fairly straightforward, but will be tailored to utilize a five-stage pipeline.
